...
export const workingpaperData: WorkingPaper[] = [
  
  {
    ...
    paperUrl: [
      {label: "ECB", url:"https://www.ecb.europa.eu/pub/pdf/scpwps/ecb.wp3258~46133509d4.en.pdf?e8dabea02989246bc5f16ccce85e3c56"},
      {label: "Bundesbank", url:"https://www.bundesbank.de/en/publications/research/discussion-papers/import-tariff-transmission-in-a-production-network-920638"},
      //"https://mpra.ub.uni-muenchen.de/125698/"
    ], 
